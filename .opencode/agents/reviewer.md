---
description: Code review agent for the Jira DORA & Planning Metrics Dashboard. Reviews pull requests and staged changes for correctness, security, performance, and convention adherence. Returns a PASS / PASS WITH COMMENTS / BLOCK verdict.
mode: subagent
permission:
  edit: deny
  bash:
